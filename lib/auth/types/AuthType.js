...
export default class AuthType {
     ...
     */
    getNextUrl(request) {
        console.log("SEBI - llamaron a getNextUrl con basePath:" + request.getBasePath() + " y path:" + request.url.path);
      //console.log("SEBI - request:" +  request);
      // console.log("SEBI - url:" +  request.url);
      // console.log("SEBI - query:" +  request.query);
    ...
    setupAuthScheme() {
        this.server.auth.scheme('security_access_control_scheme', (server, options) => ({
            authenticate: async(request, h) => {
                console.log("SEBI - entre al auth scheme")
                ...
                try {
                    ...
                    console.log("SEBI - estoy autenticado")
                    return h.authenticated({credentials})
                 } catch(error) {
                    ...
                    if (authHeaderCredentials) {
                        ...
                        try {
                            ...
                            return h.authenticated({
                                ...
                                console.log("SEBI - falle auth con header")
